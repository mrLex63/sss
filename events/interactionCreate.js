...
module.exports = {
    ...
    execute: async (interaction) => {
        ...
        const bakimmodu = new EmbedBuilder()
            ...
            .setDescription(`Herhangi bir sorunuz vs. varsa <@1150036168319189042>'e ulaşınız!`);

        if (db.fetch(`bakim`)) {
            if (interaction.user.id !== "1150036168319189042") { return interaction.reply({ embeds: [bakimmodu]}) }
        }
